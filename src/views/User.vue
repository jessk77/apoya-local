  ...
  <q-layout>
    ...
    <q-page-container>
      <div class="q-mr-lg q-ml-lg">
        ...
        <q-tabs dense v-model="tab" class="text-white" align="justify" narrow-indicator>
          <q-tab class="bg-light-green-14 text-green-10" name="general" icon="edit" label="GENERAL" />
          <q-tab class="bg-light-green-14 text-green-10" name="map" icon="place" label="MAPA" />
          <q-tab class="bg-light-green-14 text-green-10" name="image" icon="image" label="IMAGEN" />
          <q-tab class="bg-light-green-14 text-green-10" name="products" icon="dns" label="PRODUCTOS" />
          <!-- <q-tab class="bg-green-14" name="login" label="INICIO DE SESIÓN" /> -->
        </q-tabs>

        <q-separator />

         <q-tab-panels v-if="loaded" v-model="tab" animated class="text-center">
